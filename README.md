...
## 🚀 Features
**Commit**
Get AI to write a commit message for you, based on the changes.

**PR**
Generate a commit message, write a PR title and description and open the PR in the browser, all with one command.
